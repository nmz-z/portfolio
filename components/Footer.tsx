...
export function Footer(){
  return(
    ...
    <div className={styles.footerIcons}>
      <a href="https://github.com/nmz-z" target="_blank">
      ...
      <a href="mailto:idiegoo.ra@gmail.com">
        <MailLogo className={styles.mailLogo} width={50} fill="#f8f8f8"/>
      </a>
      <a href="https://drive.google.com/file/d/18fJnoLBE3SABz7gSbn1pHVChi5dwPa35/view?usp=sharing" target="_blank">
